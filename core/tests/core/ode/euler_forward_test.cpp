...
TEST_F(EulerForwardTest, NegativeStepSize) {
  ...
  EXPECT_THROW(
      { core::ode::EulerForward(f, 0.0, 1.0, {1.0}, -0.1); },
...
TEST_F(EulerForwardTest, ZeroStepSize) {
  ...
  EXPECT_THROW(
      { core::ode::EulerForward(f, 0.0, 1.0, {1.0}, 0.0); },
      std::invalid_argument);
}
...
TEST_F(EulerForwardTest, InvalidTimeInterval) {
  ...
  EXPECT_THROW(
      { core::ode::EulerForward(f, 1.0, 0.0, {1.0}, 0.1); },
      std::invalid_argument);
}
...
TEST_F(EulerForwardTest, EqualStartEndTime) {
  ...
  EXPECT_THROW(
      { core::ode::EulerForward(f, 1.0, 1.0, {1.0}, 0.1); },
      std::invalid_argument);
}
...
TEST_F(EulerForwardTest, ConstantFunction) {
  ...
  core::ode::Solution sol = core::ode::EulerForward(f, 0.0, 1.0, {5.0}, 0.1);
...
TEST_F(EulerForwardTest, LinearFunction) {
  ...
  double t1 = 1.0;
  double h = 0.1;
  core::ode::Solution sol = core::ode::EulerForward(f, t0, t1, {0.0}, h);
...
TEST_F(EulerForwardTest, ExponentialGrowth) {
  ...
  double t1 = 1.0;
  double h = 0.01;
  core::ode::Solution sol = core::ode::EulerForward(f, t0, t1, {1.0}, h);
...
TEST_F(EulerForwardTest, MultiDimensionalSystem) {
  ...
  core::ode::Solution sol = core::ode::EulerForward(f, t0, t1, y0, h);
