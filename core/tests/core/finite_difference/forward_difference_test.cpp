...
TEST(ForwardDifferenceTest, IdentityFunction) {
  ...
  auto J = core::finite_difference::ForwardDifference(f, x, h);
...
TEST(ForwardDifferenceTest, SmallerStepImprovesAccuracy) {
  ...
  auto J1 = core::finite_difference::ForwardDifference(f, x, h1);
  auto J2 = core::finite_difference::ForwardDifference(f, x, h2);
